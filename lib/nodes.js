...
module.exports = function (out, A, B, opts, mode) {
  ...
  mark(pointInPolygon, out.nodes, B, out.dB, 0, mode === 'intersect', epsilon, distance)
  mark(pointInPolygon, out.nodes, A, out.dA, bStart, mode !== 'union', epsilon, distance)
...
function mark(f, nodes, B, dB, start, flip) {
  var index = start
  do {
    var n = nodes[index]

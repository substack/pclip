...
test('point shared between polygons', function (t) {
  ...
  var e1 = [[[
    [500,200],[225,70.09617614746094],[225,329.90380859375],
    [500,200],[200,373.205078125],[200,26.794906616210938]
  ]]]
  t.ok(
    peq(pclip.exclude(A,B,xy), e0, 1e-3) || peq(pclip.exclude(A,B,xy), e1, 1e-3),
    'exclude'
  )
  t.end()
})
